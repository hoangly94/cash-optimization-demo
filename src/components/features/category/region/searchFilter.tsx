...
import { REQUEST_QUERY, REQUEST_RESET, CHANGE_CODE_FILTER } from '~stores/category/region/constants';
  ...
  return (
    <Block.Element {...componentWrapperProps}>
      <Input.Element
        ...
        {...orgsCodeProps}
        store={{
          selectorKeys: ['region', 'filters', 'regionCode'],
      ...
      <Button.Element
        {...queryButtonProps}
        store={{
          isLoadingSelectorKeys: ['base', 'buttons', 'region', 'query'],
