...
import { FETCH_HISTORY, FETCH_HISTORY_DETAIL, REQUEST_CREATING_CANCEL, REQUEST_EDITING_CANCEL, REQUEST_QUERY } from '~/stores/category/region/constants';
...
export const Element = (props: Props) => {
  ...
  React.useEffect(() => {
    ...
    dispatch({ type: HANDLE_BUTTON, keys: ['region', 'edit', 'isDisabled'], value: true });
    dispatch({ type: HANDLE_BUTTON, keys: ['region', 'history', 'isDisabled'], value: true });
  });
  //create props
  ...
  return (
    <>
      <Block.Element {...componentWrapperProps}>
        <Pagination.Element
          store={{
            totalSelectorKeys: ['region', 'queryResult'],
            action: {
              type: REQUEST_QUERY,
            }
          }}
        ...
        <Block.Element>
          ...
          <Button.Element
            ...
            store={{
              isDisabledSelectorKeys: ['base', 'buttons', 'region', 'edit'],
              action: {
                type: HANDLE_POPUP,
                keys: ['region', 'edit', 'isShown'],
                value: true,
              }
            }}
      ...
      <CreatingPopup.Element
        ...
        store={{
          isShownSelectorKeys: ['base', 'popups', 'region', 'create'],
        }}
      />
      <EditingPopup.Element
        {...editingPopupComponentProps}
        store={{
          isShownSelectorKeys: ['base', 'popups', 'region', 'edit'],
        }}
      />
      <HistoryPopup.Element
        {...historyPopupComponentProps}
        store={{
          isShownSelectorKeys: ['base', 'popups', 'region', 'history'],
        }}
        useEffect={{
      ...
      <DetailPopup.Element
        ...
        store={{
          isShownSelectorKeys: ['base', 'popups', 'region', 'historyDetail'],
        }}
        useEffect={{
