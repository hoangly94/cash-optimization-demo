...
import { SELECT_ORGS_FILTER, SELECT_NHNNTCTD_TYPE, REQUEST_QUERY, REQUEST_RESET, CHANGE_TYPE_FILTER } from '~stores/category/nhnnTctd/constants';
  ...
  return (
    <Block.Element {...componentWrapperProps}>
      <Combox.Element
        {...orgsProps}
        store={{
          defaultSelectorKeys: ['nhnnTctd', 'filters', 'orgsId'],
      ...
      <Input.Element
        ...
        store={{
          ...
          reducerType: CHANGE_TYPE_FILTER,
        }}
        max={200}
      />
