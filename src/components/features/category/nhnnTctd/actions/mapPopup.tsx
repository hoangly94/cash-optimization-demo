...
import { FETCH_MAP } from '~/stores/category/nhnnTctd/constants';
...
export const Element = (props: Props) => {
  const selector = useSelector(state => state['nhnnTctd']);
  const isShown = useSelector(state => state['base'].popups.nhnnTctd.mapPopup.isShown);
