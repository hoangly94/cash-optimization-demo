...
import { REQUEST_QUERY, SELECT_ROW } from '~stores/category/function/constants';
...
export const Element = (props: Props) => {
  const queryResult = useSelector(state => state['function'].queryResult.data);
...
const handleRowClick = (dispatch) => (item) => (e) => {
  ...
  dispatch({ type: HANDLE_BUTTON, keys: ['function', 'edit', 'isDisabled'], value: false });
}
