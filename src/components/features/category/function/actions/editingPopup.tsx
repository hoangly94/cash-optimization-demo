...
import { REQUEST_EDITING, REQUEST_EDITING_CANCEL, CHANGE_EDITING_INPUT } from '~stores/category/function/constants';
...
export const Element = (props: Popup.Props) => {
  ...
  const selectedItemSelector = useSelector(state => state['function'].selectedItem);
    ...
    <Popup.Element {...props}>
      ...
      <Block.Element {...inputWrapperProps}>
        ...
        <Input.Element
          ...
          {...inputProps}
          store={{
            selectorKeys: ['function', 'selectedItem', 'functionCode'],
      ...
      <Block.Element {...inputWrapperProps}>
        ...
        <Input.Element
          ...
          {...inputProps}
          store={{
            selectorKeys: ['function', 'selectedItem', 'functionName'],
            reducerType: CHANGE_EDITING_INPUT,
          }}
          max={50}
        />
