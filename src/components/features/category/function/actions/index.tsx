...
import { FETCH_HISTORY, FETCH_HISTORY_DETAIL, REQUEST_CREATING_CANCEL, REQUEST_EDITING_CANCEL, REQUEST_QUERY } from '~/stores/category/function/constants';
...
export const Element = (props: Props) => {
  ...
  React.useEffect(() => {
    ...
    dispatch({ type: HANDLE_BUTTON, keys: ['function', 'edit', 'isDisabled'], value: true });
    dispatch({ type: HANDLE_BUTTON, keys: ['function', 'history', 'isDisabled'], value: true });
  });
  //create props
  ...
  return (
    <>
      <Pagination.Element
        store={{
          totalSelectorKeys: ['function', 'queryResult'],
          action: {
            type: REQUEST_QUERY,
          }
        }}
      ...
      >
        ...
        <Button.Element
          ...
          store={{
            isDisabledSelectorKeys: ['base', 'buttons', 'function', 'edit'],
            action: {
              type: HANDLE_POPUP,
              keys: ['function', 'edit', 'isShown'],
              value: true,
            }
          }}
      ...
      <CreatingPopup.Element
        ...
        store={{
          isShownSelectorKeys: ['base', 'popups', 'function', 'create'],
        }}
      />
      <EditingPopup.Element
        {...editingPopupComponentProps}
        store={{
          isShownSelectorKeys: ['base', 'popups', 'function', 'edit'],
        }}
      />
      <HistoryPopup.Element
        {...historyPopupComponentProps}
        store={{
          isShownSelectorKeys: ['base', 'popups', 'function', 'history'],
        }}
        useEffect={{
