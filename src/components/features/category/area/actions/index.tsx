...
import { FETCH_HISTORY, FETCH_HISTORY_DETAIL, REQUEST_CREATING_CANCEL, REQUEST_EDITING_CANCEL, REQUEST_QUERY } from '~/stores/category/area/constants';
...
export const Element = (props: Props) => {
  ...
  React.useEffect(() => {
    ...
    dispatch({ type: HANDLE_BUTTON, keys: ['area', 'edit', 'isDisabled'], value: true });
    dispatch({ type: HANDLE_BUTTON, keys: ['area', 'history', 'isDisabled'], value: true });
  });
  //create props
  ...
  return (
    <>
      ...
      <DetailPopup.Element
        ...
        store={{
          isShownSelectorKeys: ['base', 'popups', 'area', 'historyDetail'],
        }}
        useEffect={{
