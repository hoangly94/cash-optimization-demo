...
import { SELECT_ORGS_FILTER, REQUEST_QUERY, REQUEST_RESET, CHANGE_CODE_FILTER } from '~stores/category/title/constants';
  ...
  return (
    <Block.Element {...componentWrapperProps}>
      <Input.Element
        ...
        {...orgsCodeProps}
        store={{
          selectorKeys: ['title', 'filters', 'titleCode'],
      ...
      <Button.Element
        {...queryButtonProps}
        store={{
          isLoadingSelectorKeys: ['base', 'buttons', 'title', 'query'],
