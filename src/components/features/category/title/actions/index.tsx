...
import { FETCH_HISTORY, FETCH_HISTORY_DETAIL, REQUEST_CREATING_CANCEL, REQUEST_EDITING_CANCEL, REQUEST_QUERY } from '~/stores/category/title/constants';
...
export const Element = (props: Props) => {
  ...
  React.useEffect(() => {
    ...
    dispatch({ type: HANDLE_BUTTON, keys: ['title', 'edit', 'isDisabled'], value: true });
    dispatch({ type: HANDLE_BUTTON, keys: ['title', 'history', 'isDisabled'], value: true });
  });
  //create props
  ...
  return (
    <>
      <Pagination.Element
        store={{
          totalSelectorKeys: ['title', 'queryResult'],
          action: {
            type: REQUEST_QUERY,
          }
        }}
      ...
      >
        ...
        <Button.Element
          ...
          store={{
            isDisabledSelectorKeys: ['base', 'buttons', 'title', 'edit'],
            action: {
              type: HANDLE_POPUP,
      ...
      <CreatingPopup.Element
        ...
        store={{
          isShownSelectorKeys: ['base', 'popups', 'title', 'create'],
        }}
      />
      <EditingPopup.Element
        {...editingPopupComponentProps}
        store={{
          isShownSelectorKeys: ['base', 'popups', 'title', 'edit'],
        }}
      />
      ...
      <DetailPopup.Element
        ...
        store={{
          isShownSelectorKeys: ['base', 'popups', 'title', 'historyDetail'],
        }}
        useEffect={{
