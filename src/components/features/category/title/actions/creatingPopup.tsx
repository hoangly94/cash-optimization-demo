...
import { REQUEST_CREATING, REQUEST_CREATING_CANCEL, CHANGE_CREATING_INPUT } from '~stores/category/title/constants';
...
export const Element = (props: Popup.Props) => {
  ...
  const creatingPopupSelector = useSelector(state => state['title'].creatingPopup);
    ...
    <Popup.Element {...props}>
      ...
      <Block.Element {...inputWrapperProps}>
        ...
        <Input.Element
          ...
          {...inputProps}
          store={{
            selectorKeys: ['title', 'creatingPopup', 'titleCode'],
      ...
      <Block.Element {...inputWrapperProps}>
        ...
        <Input.Element
          ...
          {...inputProps}
          store={{
            selectorKeys: ['title', 'creatingPopup', 'titleName'],
            reducerType: CHANGE_CREATING_INPUT,
          }}
          max={50}
        />
...
const validateForm = (creatingPopupSelector) => {
  if (!creatingPopupSelector.titleCode)
    return false;
  return true;
}
