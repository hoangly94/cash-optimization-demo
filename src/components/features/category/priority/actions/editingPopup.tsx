...
import { REQUEST_EDITING, REQUEST_EDITING_CANCEL, CHANGE_EDITING_INPUT } from '~stores/category/priority/constants';
...
export const Element = (props: Popup.Props) => {
  ...
  const selectedItemSelector = useSelector(state => state['priority'].selectedItem);
    ...
    <Popup.Element {...props}>
      ...
      <Block.Element {...inputWrapperProps}>
        ...
        <Input.Element
          ...
          {...inputProps}
          store={{
            selectorKeys: ['priority', 'selectedItem', 'priorityLevelCode'],
...
const validateForm = (popupSelector) => {
  // if (!popupSelector.priorityLevelCode)
  //   return false;
  return true;
}
