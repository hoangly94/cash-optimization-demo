...
export const Element = (props: Popup.Props) => {
  ...
  const historySelector = useSelector(state => state['priority'].history);
  //create props
  ...
  return (
    <Popup.Element {...props}>
      ...
      <Block.Element {...actionsWrapperProps}>
        <Pagination.Element
          store={{
            totalSelectorKeys: ['priority', 'history'],
            action: {
              type: FETCH_HISTORY,
            }
          }}
        ...
        <Block.Element>
          <Button.Element
            ...
            store={{
              isDisabledSelectorKeys: ['base', 'buttons', 'priority', 'historyDetail'],
              action: {
                type: HANDLE_POPUP,
...
const handleRowClick = (dispatch) => (item) => (e) => {
  ...
  dispatch({ type: HANDLE_BUTTON, keys: ['priority', 'historyDetail', 'isDisabled'], value: false });
}
