...
import { REQUEST_QUERY, REQUEST_RESET, CHANGE_CODE_FILTER } from '~stores/category/priority/constants';
  ...
  return (
    <Block.Element {...componentWrapperProps}>
      <Input.Element
        ...
        {...orgsCodeProps}
        store={{
          selectorKeys: ['priority', 'filters', 'priorityLevelCode'],
      ...
      <Button.Element
        {...queryButtonProps}
        store={{
          isLoadingSelectorKeys: ['base', 'buttons', 'priority', 'query'],
