...
export const Element = (props: Props) => {
  ...
  React.useEffect(() => {
    ...
    dispatch({ type: HANDLE_BUTTON, keys: ['atmCdm', 'edit', 'isDisabled'], value: true });
    dispatch({ type: HANDLE_BUTTON, keys: ['atmCdm', 'history', 'isDisabled'], value: true });
  });
  //create props
  ...
  return (
    <>
      ...
      <CreatingPopup.Element
        ...
        store={{
          isShownSelectorKeys: ['base', 'popups', 'atmCdm', 'create'],
        }}
      />
      <EditingPopup.Element
        {...editingPopupComponentProps}
        store={{
          isShownSelectorKeys: ['base', 'popups', 'atmCdm', 'edit'],
        }}
      />
      ...
      <DetailPopup.Element
        ...
        store={{
          isShownSelectorKeys: ['base', 'popups', 'atmCdm', 'historyDetail'],
        }}
        useEffect={{
