...
import { FETCH_MAP } from '~/stores/category/atmCdm/constants';
...
export const Element = (props: Props) => {
  const selector = useSelector(state => state['atmCdm']);
  const isShown = useSelector(state => state['base'].popups.atmCdm.mapPopup.isShown);
