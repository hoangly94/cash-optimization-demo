...
import { FETCH_HISTORY, FETCH_HISTORY_DETAIL, SELECT_HISTORY_ROW, SELECT_ROW } from '~stores/category/atmCdm/constants';
...
export const Element = (props: Popup.Props) => {
  ...
  const historySelector = useSelector(state => state['atmCdm'].detailPopup);
  //create props
  ...
  return (
    <Popup.Element {...props}>
      ...
      <Block.Element {...actionsWrapperProps}>
        <Pagination.Element
          store={{
            totalSelectorKeys: ['atmCdm', 'detailPopup'],
            action: {
