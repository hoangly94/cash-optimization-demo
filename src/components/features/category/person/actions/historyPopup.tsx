...
export const Element = (props: Popup.Props) => {
  ...
  const historySelector = useSelector(state => state['person'].history);
  //create props
  ...
  return (
    <Popup.Element {...props}>
      ...
      <Block.Element {...actionsWrapperProps}>
        <Pagination.Element
          store={{
            totalSelectorKeys: ['person', 'history'],
            action: {
              type: FETCH_HISTORY,
            }
          }}
        ...
        <Block.Element>
          <Button.Element
            ...
            store={{
              isDisabledSelectorKeys: ['base', 'buttons', 'person', 'historyDetail'],
              action: {
                type: HANDLE_POPUP,
...
const handleRowClick = (dispatch) => (item) => (e) => {
  ...
  dispatch({ type: HANDLE_BUTTON, keys: ['person', 'historyDetail', 'isDisabled'], value: false });
}
