...
import { FETCH_HISTORY, FETCH_HISTORY_DETAIL, REQUEST_CREATING_CANCEL, REQUEST_EDITING_CANCEL, REQUEST_QUERY } from '~/stores/category/person/constants';
...
export const Element = (props: Props) => {
  ...
  React.useEffect(() => {
    ...
    dispatch({ type: HANDLE_BUTTON, keys: ['person', 'edit', 'isDisabled'], value: true });
    dispatch({ type: HANDLE_BUTTON, keys: ['person', 'history', 'isDisabled'], value: true });
  });
  //create props
  ...
  return (
    <>
      <Pagination.Element
        store={{
          totalSelectorKeys: ['person', 'queryResult'],
          action: {
            type: REQUEST_QUERY,
          }
        }}
      ...
      >
        ...
        <Button.Element
          ...
          store={{
            isDisabledSelectorKeys: ['base', 'buttons', 'person', 'edit'],
            action: {
              type: HANDLE_POPUP,
      ...
      <CreatingPopup.Element
        ...
        store={{
          isShownSelectorKeys: ['base', 'popups', 'person', 'create'],
        }}
      />
      <EditingPopup.Element
        {...editingPopupComponentProps}
        store={{
          isShownSelectorKeys: ['base', 'popups', 'person', 'edit'],
        }}
      />
      <HistoryPopup.Element
        {...historyPopupComponentProps}
        store={{
          isShownSelectorKeys: ['base', 'popups', 'person', 'history'],
        }}
        useEffect={{
      ...
      <DetailPopup.Element
        ...
        store={{
          isShownSelectorKeys: ['base', 'popups', 'person', 'historyDetail'],
        }}
        useEffect={{
