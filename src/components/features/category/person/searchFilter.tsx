...
import { SELECT_ORGS_FILTER, REQUEST_QUERY, REQUEST_RESET, CHANGE_CODE_FILTER } from '~stores/category/person/constants';
  ...
  return (
    <Block.Element {...componentWrapperProps}>
      ...
      <Button.Element
        {...queryButtonProps}
        store={{
          isLoadingSelectorKeys: ['base', 'buttons', 'person', 'query'],
