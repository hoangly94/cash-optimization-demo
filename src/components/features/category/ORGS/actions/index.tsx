...
import { FETCH_HISTORY, FETCH_HISTORY_DETAIL, REQUEST_QUERY } from '_/stores/category/orgs/constants';
  ...
  return (
    <>
      ...
      <CreatingPopup.Element
        ...
        store={{
          isShownSelectorKeys: ['base', 'popups', 'orgs', 'create'],
        }}
      />
      <EditingPopup.Element
        {...editingPopupComponentProps}
        store={{
          isShownSelectorKeys: ['base', 'popups', 'orgs', 'edit'],
        }}
      />
      ...
      <DetailPopup.Element
        ...
        store={{
          isShownSelectorKeys: ['base', 'popups', 'orgs', 'historyDetail'],
        }}
        useEffect={{
