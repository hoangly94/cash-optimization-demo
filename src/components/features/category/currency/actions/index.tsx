...
import { FETCH_HISTORY, FETCH_HISTORY_DETAIL, REQUEST_QUERY } from '_/stores/category/currency/constants';
  ...
  return (
    <>
      ...
      <DetailPopup.Element
        ...
        store={{
          isShownSelectorKeys: ['base', 'popups', 'currency', 'historyDetail'],
        }}
        useEffect={{
