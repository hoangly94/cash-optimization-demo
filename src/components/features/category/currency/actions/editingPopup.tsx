...
import { REQUEST_EDITING, REQUEST_EDITING_CANCEL, CHANGE_EDITING_INPUT } from '~stores/category/currency/constants';
...
export const Element = (props: Popup.Props) => {
  ...
  const selectedItemSelector = useSelector(state => state['currency'].selectedItem);
    ...
    <Popup.Element {...props}>
      ...
      <Block.Element {...inputWrapperProps}>
        ...
        <Input.Element
          ...
          {...inputProps}
          store={{
            selectorKeys: ['currency', 'selectedItem', 'currencyType'],
