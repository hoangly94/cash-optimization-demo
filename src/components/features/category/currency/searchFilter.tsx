...
import { REQUEST_QUERY, REQUEST_RESET, CHANGE_CODE_FILTER } from '~stores/category/currency/constants';
  ...
  return (
    <Block.Element {...componentWrapperProps}>
      <Input.Element
        ...
        {...orgsCodeProps}
        store={{
          selectorKeys: ['currency', 'filters', 'currencyType'],
      ...
      <Button.Element
        {...queryButtonProps}
        store={{
          isLoadingSelectorKeys: ['base', 'buttons', 'currency', 'query'],
