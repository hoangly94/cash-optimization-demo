...
export const Element = (props: Popup.Props) => {
  ...
  const popupSelector = useSelector(state => state['pycRegistration'].history?.detailPopup);
  ...
  const closeButtonProps: Button.Props = {
    ...
    onClick: () => {
      ...
      dispatch({ type: HANDLE_BUTTON, keys: ['pycRegistration', 'historyDetail', 'isDisabled'], value: true });
    },
  }
