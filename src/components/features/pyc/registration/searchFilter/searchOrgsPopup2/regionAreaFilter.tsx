...
import {  SELECT_AREA_TYPE_FILTER, SELECT_REGION_TYPE_FILTER } from '~stores/pyc/searchOrgs/constants';
...
export const Element = (props: Popup.Props) => {
  ...
  //create props
  const locationTypeSelector = useSelector(state => state['pycSearchOrgs'].filters.locationType);
  ...
  return (
    <>
      <Combox.Element
        ...
        store={{
          defaultSelectorKeys: ['pycSearchOrgs', 'filters', 'regionType'],
      ...
      <Combox.Element
        width={Base.Width.PX_200}
        store={{
          defaultSelectorKeys: ['pycSearchOrgs', 'filters', 'areaType'],
