...
export const REQUEST_ORGANIZE_GET_HDB_DETAIL = root + 'REQUEST_ORGANIZE_GET_HDB_DETAIL';
export const UPDATE_ORGANIZE_GET_HDB_DETAIL = root + 'UPDATE_ORGANIZE_GET_HDB_DETAIL';

export const CHECK_VEHICLE = root + 'CHECK_VEHICLE';
export const CHECK_PERS = root + 'CHECK_PERS';
